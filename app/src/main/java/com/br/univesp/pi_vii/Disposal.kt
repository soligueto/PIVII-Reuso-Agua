...
class Disposal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val backMain = findViewById<Button>(R.id.btnBackD)

        val refreshStatus = findViewById<Button>(R.id.btnRefreshD)

        result = findViewById<TextView>(R.id.txtLevelDisp)
        ...
        Thread {
            ...
            try {
                ...
                for (i in 0 until jsonArray.length()) {
                    level = jsonArray.getJSONObject(i).getString("field5")
                }
